            ...
            <div class="glassmorphism rounded-full border border-slate-200/50 bg-white/70 px-6 py-2.5 shadow-md flex items-center justify-between">
                ...
                <div v-if="canLogin" class="flex items-center gap-5">
                    <Link
                        ...
                        class="rounded-full bg-blue-600 px-6 py-2.5 text-xs font-bold text-white shadow-md shadow-blue-500/10 hover:shadow-blue-500/20 hover:bg-blue-700 transition-all duration-300"
                    >
                        Go to Dashboard
                    </Link>
                    <template v-else>
